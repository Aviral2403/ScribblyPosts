  ...
  return (
    <div className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-[100px] py-4 bg-gray-900">
      ...
      <div className="hidden md:flex items-center justify-center space-x-2 md:space-x-4 text-gray-100 ">
        <Link to="/" className="hover:bg-[#bdc2e7] hover:text-gray-900 p-1 rounded-md">Home</Link>

        <Link to="/about" className="hover:bg-[#bdc2e7] hover:text-gray-900 p-1 rounded-md">About</Link>

        {user ? (
          <h3>
            <Link to="/write" className="hover:bg-[#bdc2e7] hover:text-gray-900 p-1 rounded-md">Write</Link>
          </h3>
        ) : (
          <h3>
            <Link to="/login" className="hover:bg-[#bdc2e7] hover:text-gray-900 p-1 rounded-md">Login</Link>
          </h3>
        )}
        ...
        {user ? (
          ...
          <>
            <h3>
              <Link to="/register" className="hover:bg-[#bdc2e7] hover:text-gray-900 p-1 rounded-md">Register</Link>
            </h3>
          </>
        )}
      </div>
